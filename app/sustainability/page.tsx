    ...
    <div className="bg-gradient-to-br from-green-100 to-indigo-100 ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 mx-2 md:mx-10 pb-14 object-center align-middle ">
        ...
        <div className="mx-auto">
          <Image className="rounded-xl px-10 md:px-0" src={"/Sustain_Img3_E1.png"} alt="Geese" width={600} height={1000}/>
        </div>
        ...
        <div className="mx-auto ">
          <Image className="rounded-xl px-10 md:px-0" src={"/Sustain_Img2_E1.png"} alt="Geese" width={600} height={1000}/>
        </div>
      </div>
      <div>
                ...
                <div className="flex flex-col items-center text-5xl pb-20 bg-[url('/Sustain_Vine2.svg')] bg-no-repeat bg-right-bottom">
                        <p className=" text-3xl md:text-4xl">Find out more about us</p>
